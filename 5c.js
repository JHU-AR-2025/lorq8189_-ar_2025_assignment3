    ...
    */
        ...
        vec3 lColor, vec3 lPos, vec3 N, vec3 V, vec3 kd, vec3 ks, float shin)
    {
        ...
        */
        ...
        vec3 color = lColor*kd*dot(N, L) + lColor*ks*pow(max(dot(R, V), 0.0), shin);
        

    
        return color; // Dummy return value. Please change this
    }
    ...
    void main()
    {
        ...
        color += shadePointLight(
            ...
            uPointLightPos*-1.0,
            N, V,
            uMatDiffuse*1.5, uMatSpecular*1.1, 4.0
        );
    ...
    // uMatAmbient uMatDiffuse uMatSpecular uMatShininess uPointLightColor uPointLightPos     
    ...
    // Material
    shaderMat.setFloat("uMatAmbient", .45)
    shaderMat.setColor3("uMatDiffuse",  new BABYLON.Color3(0.35, .48, 1));
    shaderMat.setColor3("uMatSpecular", new BABYLON.Color3(1, 0, .8));
    shaderMat.setFloat("uMatShininess", 8.0);

    // Point Light
    shaderMat.setColor3("uPointLightColor", new BABYLON.Color3(1,1,1));
    shaderMat.setVector3("uPointLightPos", new BABYLON.Vector3(2.0,3.5,3.0));
